...
public class CreateOpeDatoAsistenciaCommandValidator : AbstractValidator<CreateOpeDatoAsistenciaCommand>
{
    public CreateOpeDatoAsistenciaCommandValidator(IStringLocalizer<ValidationMessages> localizer)
    {
        RuleFor(p => p.Fecha)
