...
namespace DGPCE.Sigemad.Application.Features.Ope.Datos.OpeDatosEmbarquesDiarios.Vms
{
    public class OpeDatoEmbarqueDiarioVm : BaseDomainModel<int>
    {
        ...
        public virtual OpeLineaMaritima OpeLineaMaritima { get; set; } = null!;
    }
}
