CREATE TABLE [Auditoria_OPE_AreaDescanso](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[FechaRegistro] datetime2 NOT NULL,
	[TipoMovimiento] char(1) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[IdOpeAreaDescanso] int NOT NULL  FOREIGN KEY REFERENCES OPE_AreaDescanso(Id),
...
ALTER TABLE Auditoria_OPE_AreaDescanso WITH NOCHECK ADD CONSTRAINT CK__Auditoria__Ope_AreaDescanso_TipoM__06ED0088 CHECK (([TipoMovimiento]='D' OR [TipoMovimiento]='U' OR [TipoMovimiento]='I'));