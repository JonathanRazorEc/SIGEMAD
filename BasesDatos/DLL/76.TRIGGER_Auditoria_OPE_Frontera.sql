CREATE TRIGGER trg_Auditoria_OPE_Frontera
...
BEGIN
    ...
    BEGIN
        ...
        INSERT INTO Auditoria_OPE_Frontera (FechaRegistro, TipoMovimiento, IdOpeFrontera, Nombre,IdCcaa,IdProvincia,IdMunicipio,Carretera,PK,CoordenadaUTM_X,CoordenadaUTM_Y,TransitoMedioVehiculos      ,TransitoAltoVehiculos,FechaCreacion,CreadoPor,FechaModificacion,ModificadoPor,FechaEliminacion,EliminadoPor,Borrado)
