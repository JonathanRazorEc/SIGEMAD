CREATE TABLE [Auditoria_OPE_DatoAsistencia](
...
ALTER TABLE Auditoria_OPE_DatoAsistencia WITH NOCHECK ADD CONSTRAINT CK__Auditoria__Ope_DatoAsistencia_TipoM__06ED0088 CHECK (([TipoMovimiento]='D' OR [TipoMovimiento]='U' OR [TipoMovimiento]='I'));